...
function Song({ key, song, addSong, removeSong }) {
  ...
  return (
    <ListGroup className="list-group list-group-horizontal">
      <ListGroup.Item className="col-md-3 list-group-item" style={{ borderRight: 'none' }}>
        <Image src={song.imageurl} alt="none" style={{ width: "100%" }}></Image>
      </ListGroup.Item>
      <ListGroup.Item className="col-md-8 list-group-item" style={{ borderLeft: 'none', borderRight: 'none' }}>
        <a
          href={song.songurl}
          target="_blank"
      ...
      <ListGroup.Item className="col-md-1 list-group-item" style={{ borderLeft: 'none' }}>
        <IconButton
          onClick={handleClick}
